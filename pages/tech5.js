      ...
      <div className="container-fluid" style={{ minHeight: '85vh' }}>
        ...
        >
          ...
          >
            ...
            <p>
              MOFA(Multi-Direction Opposed Fired Air）多方位对冲燃烬风低氮燃烧技术是本公司科研团队联合美国爱邦环保公司与耶鲁大学联合开发具有国际领先水平的脱硝技术。烟气脱硝方法根据不同型号锅炉和烟气中氮氧化物浓度选择合适有效的方法。降低氮氧化物排放有二种途径，一是减少氮氧化物的产生在锅炉上使用低氮燃烧技术；二是烟气中的氮氧化物中和成氮气或硝酸盐。
            </p>
            <p>
            ...
            <p>
              采用多方位对冲回流烟气低氮燃烧技术，其分级燃烧合理分配和控制了火焰中心的温度和O2含量，进行分级布风燃烧，从除尘器引风机出口引入部分燃烧过的烟气混合到鼓风机的空气中，再通过MOFA一次风、二次风和火上风进行分级布风燃烧。MOFA火上风通过安放在锅炉上的喷嘴中以高速射流的形式从不同方位送入炉膛，这种含氧量低的烟气与炉膛内上升烟气相遇产生强烈紊流，使炉内烟气混合更均匀，增长了烟气在炉膛内的滞留时间，提高了燃烧效率，最主要的是烟气在这种低氧低温环境中分级燃烧，大大减少的氮氧化物的产生，从而达到脱硝的目的。应用在非低氮燃烧类型的锅炉中，它的脱硝效率最高可达５5％，可以提高锅炉燃烧效率０.４％。
            </p>
          </div>
        </div>
      </div>
