          ...
          <table className="table table-hover">
            ...
            <tbody>
              ...
              <tr className="table-primary">
                ...
                <td>FS/JS - 130型1台<br/> FS/JS - 75型2台</td>
                <td>达标， 超低排放</td>
              </tr>
              <tr className="table-light">
                <td>54</td>
              ...
              <tr className="table-primary">
                ...
                <td>内蒙古常盛制药有限公司</td>
                <td>2X75t/h链条炉</td>
                <td>FS - 75型2台<br/> FS/JS - 75型1台<br/> SNCR - 75型3台<br/>低氮燃烧 - 75型3台</td>
                <td>达标， 超低排放</td>
              </tr>
              <tr className="table-light">
                <td>56</td>
                ...
                <td>4X90MW热水锅炉</td>
                <td>FS/JS - 130型4台<br/>LQDM 4000型1台</td>
                <td>达标， 超低排放</td>
              </tr>
              <tr className="table-primary">
                <td>57</td>
                <td>江西永冠科技有限公司</td>
                <td>1X75t/h循环流化床</td>
                <td>FS/JS - 75型1台<br/>LQDM 2500型1台</td>
                <td>达标， 超低排放</td>
              </tr>
              <tr className="table-light">
                <td>58</td>
                <td>中煤东顺清洁能源有限公司</td>
                <td>2X75t/h煤粉炉</td>
                <td>FS/SD - 75型2台<br/> SNCR+SCR-75型脱硝2台</td>
                <td>达标， 超低排放</td>
              </tr>
            </tbody>
          </table>
