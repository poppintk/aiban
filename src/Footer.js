    ...
    return (
      ...
      >
        ...
        <div style={{ width: '60%', display: 'flex', minWidth: '600px' }}>
          ...
          <div style={subItem}>网站地图</div>
          <div style={subItem}>技术支持</div>
          <div style={subItem}>联系我们</div>
          <div style={{ width: '300px', padding: '20px', display: 'flex' }}>
            ...
            <div>
              ...
              >
                ...
                <option value="http://green.sina.com.cn/">
                  -----新浪环保-----
                </option>
                <option value="http://www.dowater.com/">
                  中国污水处理工程网
                </option>
                <option value="http://www.cenews.com.cn/">
                  ----中国环境网----
                </option>
                <option value="http://www.chinaenvironment.com/">
                  ----中国环保网----
                </option>
                <option value="http://www.zhb.gov.cn/">
                  ----中国环保部----
                </option>
                <option value="http://www.epday.com/">
                  --中国环境保护网--
                </option>
